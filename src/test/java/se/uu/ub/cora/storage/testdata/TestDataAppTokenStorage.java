...
public class TestDataAppTokenStorage {
	...
	public static RecordStorageInMemory createRecordStorageInMemoryWithTestData(String basePath) {
		...
		// addPlace(recordsOnDisk);
		// addSecondPlace(recordsOnDisk);
		// addMetadata(recordsOnDisk);
		// addPresentation(recordsOnDisk);
		// addText(recordsOnDisk);
		...
		// addRecordTypeBinary(recordsOnDisk);
		addRecordTypeImage(recordsOnDisk);
		// addRecordTypeRecordTypeAutoGeneratedId(recordsOnDisk);
		// addRecordTypePlace(recordsOnDisk);
		// addRecordTypeAbstractAuthority(recordsOnDisk);

		// DataGroup dummy = DataGroup.withNameInData("dummy");
		// recordsOnDisk.create("metadataCollectionVariable", "dummy1", dummy,
		// DataGroup.withNameInData("collectedLinksList"), "cora");
		// recordsOnDisk.create("metadataCollectionVariableChild", "dummy1",
		// dummy,
		// DataGroup.withNameInData("dummy"), "cora");
		// recordsOnDisk.create("metadataItemCollection", "dummy1", dummy,
		// DataGroup.withNameInData("collectedLinksList"), "cora");
		// recordsOnDisk.create("metadataCollectionItem", "dummy1", dummy,
		// DataGroup.withNameInData("collectedLinksList"), "cora");
		// recordsOnDisk.create("metadataTextVariable", "dummy1", dummy,
		// DataGroup.withNameInData("collectedLinksList"), "cora");
		// recordsOnDisk.create("metadataRecordLink", "dummy1", dummy,
		// DataGroup.withNameInData("collectedLinksList"), "cora");
		// recordsOnDisk.create("metadataRecordRelation", "dummyRecordRelation",
		// dummy,
		// DataGroup.withNameInData("collectedLinksList"), "cora");
		// recordsOnDisk.create("metadataResourceLink", "dummyResourceLink",
		// dummy,
		// DataGroup.withNameInData("collectedLinksList"), "cora");
	...
	// private static void addRecordTypeSystemOneUser(RecordStorageOnDisk
	// recordsOnDisk) {
	// String recordType = "recordType";
	//
	// DataGroup dataGroup =
	// DataCreator.createRecordTypeWithIdAndUserSuppliedIdAndAbstract(
	// "systemOneUser", "false", "false");
	//
	// recordsOnDisk.create(recordType, "systemOneUser", dataGroup,
	// DataGroup.withNameInData("collectedLinksList"), "cora");
	// }
